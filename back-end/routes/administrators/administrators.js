...
//   } catch (error) {
//     console.error(
//       "Erreur d'insertion administrateur dans la base de donnée",
//       error,
//     );
...
//   try {
//     const result = await pool.query(
//       `UPDATE "user" SET first_name = $1, name = $2, email = $3,
//         password = $4, administrator = $5 WHERE user_id = $6`,
//       [first_name, name, email, password, administrator, user_id],
//     );

//     console.log(
//       "Mise à jour de l'administrateur dans la base de données réussie",
//     );
//     res.status(201).json({ message: "Administrateur mis à jour avec succès!" });
//   } catch (error) {
//     console.error(
//       "Erreur lors de la mise à jour de l'administrateur dans la base de données",
//       error,
//     );
//     res.status(500).json({ error: "Erreur interne du serveur" });
//   }
...
//   } catch (error) {
//     console.error(
//       "Erreur lors de la suppression de l'administrateur dans la base de données",
//       error,
//     );
//     res
//       .status(500)
//       .json({ error: "Impossible de supprimer cet administrateur" });
//   }
// });
